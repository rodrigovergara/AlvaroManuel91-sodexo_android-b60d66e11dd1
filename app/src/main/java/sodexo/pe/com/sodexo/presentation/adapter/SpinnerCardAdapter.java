...
public class SpinnerCardAdapter extends BaseAdapter {
    private List<CardEntityaasd> list;
    private LayoutInflater layoutInflater;

    public SpinnerCardAdapter(Context context) {
    ...
    public void addCards(List<CardEntityaasd> list) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        holder.tvcardItem.setText(list.get(i).getCardType());
        return convertView;
    }
