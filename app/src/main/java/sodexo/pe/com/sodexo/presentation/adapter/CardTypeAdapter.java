...
public class CardTypeAdapter extends BaseAdapter {
    ...
    @Override
    public CardTypeEntity getItem(int i) {
        return list.get(i);
    }
    ...
    public void addCards(List<CardTypeEntity> list) {
        this.list.add(new CardTypeEntity("0","Elige una opcion"));
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        holder.tvcardItem.setText(list.get(i).getCardDescription());
        return convertView;
    }
